...
- [al-folio](#al-folio)
  ...
  - [Composing content](#composing-content)
...
For this site's custom Docker, draft preview, and `jekyll-compose` workflow, see [simon-customized-readme.md](simon-customized-readme.md).
